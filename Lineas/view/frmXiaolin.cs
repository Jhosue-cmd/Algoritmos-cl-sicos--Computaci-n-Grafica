    ...
    public partial class frmXiaolin : Form
    {
        ...
        private void btnDibujar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Dibujar la línea usando el algoritmo de Xiaolin Wu
                ...
                MessageBox.Show($"Línea dibujada correctamente con Xiaolin Wu.\n\n" +
                              $"Punto inicial: ({x1}, {y1})\n" +
                              $"Punto final: ({x2}, {y2})\n" +
                              $"Pendiente: {infoPendiente}\n" +
                              $"Distancia: {distancia:F2} unidades\n" +
                              $"Escala aplicada: {ESCALA}x\n\n" +
                              $"Algoritmo: Xiaolin Wu (con anti-aliasing)\n" +
                              $"Nota: Observe los bordes suavizados de la línea.",
